...
var grammar = {
    ...
    {"name": "value", "symbols": [(myLexer.has("lparen") ? {type: "lparen"} : lparen), "value", (myLexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": d=> d[1]},
    ...
    {"name": "number", "symbols": ["number", "_", (myLexer.has("times") ? {type: "times"} : times), "_", "number"], "postprocess": function(d) {return d[0]*d[4]; }},
