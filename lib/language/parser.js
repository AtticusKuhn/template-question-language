...
var grammar = {
    ...
    {"name": "number", "symbols": ["number", "_", (lexer.has("plus") ? {type: "plus"} : plus), "_", "number"], "postprocess": function(d) {return d[0]+d[4]; }},
    {"name": "number", "symbols": ["number", "_", (lexer.has("times") ? {type: "times"} : times), "_", "number"], "postprocess": function(d) {return d[0]*d[4]; }},
